                ...
                <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                    ...
                    <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                        ...
                        <div >
                            ...
                            <input className="placeholder:text-slate-400 block text-white dark:bg-gray-700 w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Blog Title..." type="text" name="search" />
                        </div>

                        <label className="text-input-label">Blog</label>
                        <textarea id="editor" className=" rows 8 block w-full px-0 text-sm text-gray-800  border-0 dark:bg-gray-700 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
                    </div>
                </div>
                ...
                <div className="px-4 py-2 bg-white rounded-b-lg " >
                    ...
                    <div>
                        <label className="static">
                            <input className="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Search for blog title..." type="text" name="search" />
                        </label>
                    </div>

                    <button className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-emerald-500 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-emerald-900">
                        Update Post
                    </button>
                </div>
            </form>
