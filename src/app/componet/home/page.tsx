...
export default function page() {
    return (
        ...
        <div>
            ...
            <div className="relative z-10 text-center py-5 md:py-2 bg-transparent"><Navbar/></div>
                ...
                <div className="relative z-10 text-center py-20 md:py-40">
                    ...
                    <a href="{{ home.button_link }}" className="no-underline inline-block bg-yellow-800 text-white uppercase text-sm tracking-widest font-heading px-8 py-4">READ THE BLOG</a>
                </div>
