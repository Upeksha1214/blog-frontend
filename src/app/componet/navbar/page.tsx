...
<div x-data="{showMenu: false}" className="flex items-center">
    <button className="showMenu = true">
    ...
    <div x-show="showMenu" className="fixed inset-0 w-full h-full bg-white z-50 text-yellow-900">
        <div className="container h-full mx-auto px-6 py-8 relative z-10 flex flex-col items-center justify-center text-2xl uppercase font-bold tracking-widest space-y-6">
            <button className="showMenu = false absolute top-0 left-0 mt-8 ml-6">
             ...
             {/* if navigation.items  */}
                ...
                {/* for item in navigation.items  */}
                    ...
                    <a href="{{ item.url }}" className="inline-block border-b-4 border-transparent hover:border-yellow-900">item text</a>
                {/* endfor  */}
             {/* endif  */}
        </div>
